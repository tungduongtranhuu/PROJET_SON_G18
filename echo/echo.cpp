...
struct mydsp : public dsp {
	...
	#define FAUST_FILE_NAME "echo.dsp"
...
echo::echo() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void echo::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void echo::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float echo::getParamValue(const std::string& path)
{
