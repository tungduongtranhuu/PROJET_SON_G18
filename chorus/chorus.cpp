...
struct mydsp : public dsp {
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst4 = 4.656613e-10f * (1.0f - fConst3);
		fConst5 = 1.0f / fConst0;
		fConst6 = 0.001f * fConst0;
		fConst7 = 1.0f / std::tan(18849.557f / fConst0);
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider1 = static_cast<FAUSTFLOAT>(5.5f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Depth", &fHslider1, FAUSTFLOAT(5.5f), FAUSTFLOAT(0.5f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider0, "unit", "Hz");
		ui_interface->addHorizontalSlider("Rate", &fHslider0, FAUSTFLOAT(0.8f), FAUSTFLOAT(0.05f), FAUSTFLOAT(5.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("Volume", &fHslider2, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = fConst5 * static_cast<float>(fHslider0);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec1[IOTA0 & 65535] = fTemp0 * ((fRec1[0] > 0.006f) ? 1.0f : ((fRec1[0] > 0.0018f) ? 238.09525f * (fRec1[0] + -0.0018f) : 0.0f));
			iRec3[0] = 1103515245 * iRec3[1] + 12345;
			fRec2[0] = fConst4 * static_cast<float>(iRec3[0]) + fConst3 * fRec2[1];
			float fTemp1 = ((1 - iVec0[1]) ? 0.0f : fSlow0 + fRec5[1]);
			fRec5[0] = fTemp1 - std::floor(fTemp1);
			float fTemp2 = fVec1[(IOTA0 - static_cast<int>(std::min<float>(4.41e+04f, std::max<float>(0.0f, fConst6 * (fSlow1 * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec5[0]), 65535))] + 0.02f * fRec2[0] + 1e+01f))))) & 65535];
			fVec3[0] = fTemp2;
			fRec0[0] = -(fConst9 * (fConst8 * fRec0[1] - (fTemp2 + fVec3[1])));
			float fTemp3 = fSlow2 * fRec0[0];
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp3);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp3);
			iVec0[1] = iVec0[0];
			fRec1[1] = fRec1[0];
			IOTA0 = IOTA0 + 1;
			iRec3[1] = iRec3[0];
	...
	#define FAUST_FILE_NAME "chorus.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Depth", fHslider1, 5.5f, 0.5f, 1e+01f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("Rate", fHslider0, 0.8f, 0.05f, 5.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Volume", fHslider2, 1.0f, 0.0f, 2.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Depth, "Depth", fHslider1, 5.5f, 0.5f, 1e+01f, 0.01f) \
		p(HORIZONTALSLIDER, Rate, "Rate", fHslider0, 0.8f, 0.05f, 5.0f, 0.001f) \
		p(HORIZONTALSLIDER, Volume, "Volume", fHslider2, 1.0f, 0.0f, 2.0f, 0.01f) \
...
chorus::chorus() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void chorus::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void chorus::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float chorus::getParamValue(const std::string& path)
{
