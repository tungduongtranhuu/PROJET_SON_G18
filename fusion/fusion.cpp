...
struct mydsp : public dsp {
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst7 = (fConst5 + 1.0f) / fConst2 + 1.0f;
		...
		fConst15 = std::tan(15079.645f / fConst0);
		...
		fConst22 = 3.1415927f / (fConst0 * std::sin(4272.566f / fConst0));
		fConst23 = std::tan(2136.283f / fConst0);
		fConst24 = 1.0f / fConst23;
		fConst25 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst23));
		fConst26 = std::tan(471.2389f / fConst0);
		fConst27 = 1.0f / mydsp_faustpower2_f(fConst26);
		fConst28 = 2.0f * (1.0f - fConst27);
		fConst29 = 1.0f / fConst26;
		fConst30 = (fConst29 + -1.0f) / fConst26 + 1.0f;
		fConst31 = 1.0f / ((fConst29 + 1.0f) / fConst26 + 1.0f);
		fConst32 = 1.0f - fConst29;
		fConst33 = std::exp(-(4e+02f / fConst0));
		fConst34 = std::exp(-(666.6667f / fConst0));
		fConst35 = 1.0f / std::tan(235.61945f / fConst0);
		fConst36 = 1.0f - fConst35;
		fConst37 = 1.0f / (fConst35 + 1.0f);
		fConst38 = std::exp(-(14.285714f / fConst0));
		fConst39 = std::exp(-(333.33334f / fConst0));
		fConst40 = 8388607.0f * (1.0f - fConst34);
		fConst41 = std::exp(-(1e+01f / fConst0));
		fConst42 = std::exp(-(2e+02f / fConst0));
		fConst43 = 8388607.0f * (1.0f - fConst33);
		fConst44 = 1.0f / (fConst29 + 1.0f);
		fConst45 = 0.765f / fConst26;
		fConst46 = std::tan(251.32741f / fConst0);
		fConst47 = 1.0f / (fConst46 * fConst19);
		fConst48 = 1.0f / fConst46;
		fConst49 = 1.0f - fConst48;
		fConst50 = 1.0f / (fConst48 + 1.0f);
		fConst51 = 1.0f / (fConst2 * fConst13);
		fConst52 = 1.0f - fConst5;
		fConst53 = 1.0f / (fConst5 + 1.0f);
		fConst54 = 0.7943282f / fConst3;
		fConst55 = 0.1f / fConst7;
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Volume", &fHslider4, FAUSTFLOAT(0.7f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = std::tan(fConst21 * ((fSlow2 > 1.8e+03f) ? fSlow2 : 1.8e+03f));
		float fSlow4 = 1.0f / fSlow3;
		float fSlow5 = (fSlow4 + 1.4142135f) / fSlow3 + 1.0f;
		float fSlow6 = 1.0f - 1.0f / mydsp_faustpower2_f(fSlow3);
		float fSlow7 = (fSlow4 + -1.4142135f) / fSlow3 + 1.0f;
		float fSlow8 = static_cast<float>(fHslider3);
		float fSlow9 = -0.14f * fSlow8;
		float fSlow10 = ((fSlow9 > -2.5f) ? fSlow9 : -2.5f);
		int iSlow11 = fSlow10 > 0.0f;
		float fSlow12 = fConst22 * std::pow(1e+01f, 0.05f * std::fabs(fSlow10));
		float fSlow13 = ((iSlow11) ? fConst22 : fSlow12);
		float fSlow14 = fConst24 * (fConst24 + fSlow13) + 1.0f;
		float fSlow15 = ((iSlow11) ? fSlow12 : fConst22);
		float fSlow16 = fConst24 * (fConst24 - fSlow15) + 1.0f;
		float fSlow17 = fConst24 * (fConst24 - fSlow13) + 1.0f;
		float fSlow18 = 0.12f * fSlow8;
		float fSlow19 = ((fSlow18 > 0.9f) ? fSlow18 : 0.9f);
		float fSlow20 = 0.25f * fSlow8 + 0.35f;
		float fSlow21 = 0.266f * fSlow8 * fSlow20;
		float fSlow22 = fConst24 * (fConst24 + fSlow15) + 1.0f;
		float fSlow23 = 1.2f * static_cast<float>(fHslider4);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec1[0] = fSlow0 + 0.999f * fRec1[1];
			fRec2[0] = fSlow1 + 0.999f * fRec2[1];
			float fTemp0 = fConst25 * fRec10[1];
			float fTemp1 = static_cast<float>(input0[i0]);
			fVec0[0] = fTemp1;
			fRec18[0] = fTemp1 + 0.995f * fRec18[1] - fVec0[1];
			fRec17[0] = -(fConst37 * (fConst36 * fRec17[1] - fConst35 * (fRec18[0] - fRec18[1])));
			float fTemp2 = std::fabs(fRec17[0]);
			float fTemp3 = ((fTemp2 > fRec16[1]) ? fConst39 : fConst38);
			fRec16[0] = fTemp2 * (1.0f - fTemp3) + fRec16[1] * fTemp3;
			fRec15[0] = fConst40 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec16[0])) + -3.0f, 0.0f) + fConst34 * fRec15[1];
			float fTemp4 = fRec17[0] * std::pow(1e+01f, 0.05f * fRec15[0]);
			float fTemp5 = std::pow(std::fabs(fSlow20 * fTemp4), 1.5f) + 1.0f;
			float fTemp6 = fSlow21 * (fTemp4 / fTemp5);
			float fTemp7 = std::fabs(fTemp6);
			float fTemp8 = tanhf(2.772f * ((fTemp6 > 0.0f) ? fSlow21 * (fTemp4 / (fTemp5 * (std::pow(fTemp7, 2.1f) + 1.0f))) : fSlow21 * (fTemp4 / (fTemp5 * (std::pow(fTemp7, 2.8f) + 1.0f)))) * fSlow19);
			float fTemp9 = std::fabs(0.765f * fTemp8);
			float fTemp10 = ((fTemp9 > fRec14[1]) ? fConst42 : fConst41);
			fRec14[0] = fTemp9 * (1.0f - fTemp10) + fRec14[1] * fTemp10;
			fRec13[0] = fConst43 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec14[0])) + -2.0f, 0.0f) + fConst33 * fRec13[1];
			float fTemp11 = fTemp8 * std::pow(1e+01f, 0.05f * fRec13[0]);
			fVec1[0] = fTemp11;
			fRec12[0] = fConst44 * (0.765f * (fTemp11 + fVec1[1]) - fConst32 * fRec12[1]);
			fRec11[0] = fRec12[0] - fConst31 * (fConst30 * fRec11[2] + fConst28 * fRec11[1]);
			fRec20[0] = fConst44 * (fConst45 * (fTemp11 - fVec1[1]) - fConst32 * fRec20[1]);
			fRec19[0] = fRec20[0] - fConst31 * (fConst30 * fRec19[2] + fConst28 * fRec19[1]);
			fRec10[0] = fConst31 * (fConst27 * (fRec19[2] + (fRec19[0] - 2.0f * fRec19[1])) + 1.4125376f * (fRec11[2] + fRec11[0] + 2.0f * fRec11[1])) - (fRec10[2] * fSlow17 + fTemp0) / fSlow14;
			fRec9[0] = (fTemp0 + fRec10[0] * fSlow22 + fRec10[2] * fSlow16) / fSlow14 - (fRec9[2] * fSlow7 + 2.0f * fRec9[1] * fSlow6) / fSlow5;
			fRec8[0] = (fRec9[2] + fRec9[0] + 2.0f * fRec9[1]) / fSlow5 - fConst20 * (fConst18 * fRec8[2] + fConst16 * fRec8[1]);
			float fTemp12 = fRec8[2] + fRec8[0] + 2.0f * fRec8[1];
			fVec2[0] = fTemp12;
			fRec7[0] = -(fConst50 * (fConst49 * fRec7[1] - fConst47 * (fTemp12 - fVec2[1])));
			fRec6[0] = fRec7[0] - fConst14 * (fConst12 * fRec6[2] + fConst10 * fRec6[1]);
			float fTemp13 = fRec6[2] + fRec6[0] + 2.0f * fRec6[1];
			fVec3[0] = fTemp13;
			fRec5[0] = -(fConst53 * (fConst52 * fRec5[1] - fConst51 * (fTemp13 - fVec3[1])));
			fRec4[0] = fRec5[0] - fConst8 * (fConst6 * fRec4[2] + fConst4 * fRec4[1]);
			fRec22[0] = -(fConst53 * (fConst52 * fRec22[1] - fConst14 * (fTemp13 + fVec3[1])));
			fRec21[0] = fRec22[0] - fConst8 * (fConst6 * fRec21[2] + fConst4 * fRec21[1]);
			float fTemp14 = fRec21[2] + fRec21[0] + 2.0f * fRec21[1] + fConst54 * (fRec4[2] + (fRec4[0] - 2.0f * fRec4[1]));
			float fTemp15 = fConst8 * fTemp14;
			float fTemp16 = fSlow23 * ((std::fabs(fTemp15) > 0.01f) ? fTemp15 : fConst55 * fTemp14);
			fVec4[0] = fTemp16;
			fRec3[0] = 0.995f * fRec3[1] + fTemp16 - fVec4[1];
			fRec0[IOTA0 & 65535] = fRec3[0] + fRec2[0] * fRec0[(IOTA0 - (static_cast<int>(std::min<float>(fConst1, std::max<float>(0.0f, fConst0 * fRec1[0]))) + 1)) & 65535];
			float fTemp17 = fRec0[(IOTA0 - 1) & 65535];
			float fTemp18 = fRec0[IOTA0 & 65535];
			float fTemp19 = fTemp18 - fTemp17;
			float fTemp20 = ((std::fabs(fTemp19) <= 0.001f) ? std::max<float>(-1.0f, std::min<float>(1.0f, 0.5f * (fTemp18 + fTemp17))) : ((((fTemp18 <= 1.0f) & (fTemp18 >= -1.0f)) ? 0.5f * mydsp_faustpower2_f(fTemp18) : fTemp18 * static_cast<float>((fTemp18 > 0.0f) - (fTemp18 < 0.0f)) + -0.5f) - (((fTemp17 <= 1.0f) & (fTemp17 >= -1.0f)) ? 0.5f * mydsp_faustpower2_f(fTemp17) : fTemp17 * static_cast<float>((fTemp17 > 0.0f) - (fTemp17 < 0.0f)) + -0.5f)) / fTemp19);
	...
	FAUST_ADDHORIZONTALSLIDER("Volume", fHslider4, 0.7f, 0.0f, 1.0f, 0.01f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(HORIZONTALSLIDER, Volume, "Volume", fHslider4, 0.7f, 0.0f, 1.0f, 0.01f) \
