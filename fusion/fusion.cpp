...
struct mydsp : public dsp {
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst5 = std::exp(-(2e+03f / fConst0));
		fConst6 = std::tan(14137.167f / fConst0);
		fConst7 = mydsp_faustpower2_f(fConst6);
		fConst8 = 2.0f * (1.0f - 1.0f / fConst7);
		fConst9 = 1.0f / fConst6;
		fConst10 = (fConst9 + -1.0f) / fConst6 + 1.0f;
		fConst11 = 1.0f / ((fConst9 + 1.0f) / fConst6 + 1.0f);
		fConst12 = 21991.148f / fConst0;
		fConst13 = std::tan(fConst12);
		fConst14 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst13));
		fConst15 = 1.0f / fConst13;
		fConst16 = (fConst15 + -1.4142135f) / fConst13 + 1.0f;
		fConst17 = (fConst15 + 1.4142135f) / fConst13 + 1.0f;
		fConst18 = 1.0f / fConst17;
		fConst19 = std::tan(16336.282f / fConst0);
		fConst20 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst19));
		fConst21 = fConst0 * std::sin(32672.564f / fConst0);
		fConst22 = 2.5132742f / fConst21;
		fConst23 = 1.0f / fConst19;
		fConst24 = (fConst23 - fConst22) / fConst19 + 1.0f;
		fConst25 = 1.0f / ((fConst23 + fConst22) / fConst19 + 1.0f);
		fConst26 = std::tan(15079.645f / fConst0);
		...
		fConst32 = std::tan(7853.9814f / fConst0);
		fConst33 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst32));
		fConst34 = fConst0 * std::sin(15707.963f / fConst0);
		fConst35 = 3.1415927f / fConst34;
		fConst36 = 1.0f / fConst32;
		fConst37 = (fConst36 - fConst35) / fConst32 + 1.0f;
		fConst38 = 1.0f / ((fConst36 + fConst35) / fConst32 + 1.0f);
		fConst39 = 3.1415927f / fConst0;
		fConst40 = 3.1415927f / (fConst0 * std::sin(3769.9111f / fConst0));
		fConst41 = std::tan(1884.9556f / fConst0);
		fConst42 = 1.0f / fConst41;
		fConst43 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst41));
		fConst44 = std::tan(471.2389f / fConst0);
		fConst45 = 1.0f / mydsp_faustpower2_f(fConst44);
		fConst46 = 2.0f * (1.0f - fConst45);
		fConst47 = 1.0f / fConst44;
		fConst48 = (fConst47 + -1.0f) / fConst44 + 1.0f;
		fConst49 = 1.0f / ((fConst47 + 1.0f) / fConst44 + 1.0f);
		fConst50 = 1.0f - fConst47;
		fConst51 = std::exp(-(4e+02f / fConst0));
		fConst52 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst1));
		fConst53 = fConst0 * std::sin(fConst12);
		fConst54 = 3.7699113f / fConst53;
		fConst55 = (fConst2 - fConst54) / fConst1 + 1.0f;
		fConst56 = (fConst2 + fConst54) / fConst1 + 1.0f;
		fConst57 = 1.0f / fConst56;
		fConst58 = std::tan(2513.2742f / fConst0);
		fConst59 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst58));
		fConst60 = fConst0 * std::sin(5026.5483f / fConst0);
		fConst61 = 2.8274333f / fConst60;
		fConst62 = 1.0f / fConst58;
		fConst63 = (fConst62 - fConst61) / fConst58 + 1.0f;
		fConst64 = (fConst62 + fConst61) / fConst58 + 1.0f;
		fConst65 = 1.0f / fConst64;
		fConst66 = std::exp(-(666.6667f / fConst0));
		fConst67 = std::exp(-(2e+02f / fConst0));
		fConst68 = 1.0f - fConst67;
		fConst69 = 1.0f / std::tan(251.32741f / fConst0);
		fConst70 = 1.0f - fConst69;
		fConst71 = 1.0f / (fConst69 + 1.0f);
		fConst72 = std::exp(-(14.285714f / fConst0));
		fConst73 = std::exp(-(333.33334f / fConst0));
		fConst74 = 8388607.0f * (1.0f - fConst66);
		fConst75 = 1.0f / std::tan(2261.9468f / fConst0);
		fConst76 = 1.0f - fConst75;
		fConst77 = 1.0f / (fConst75 + 1.0f);
		fConst78 = 3.9938557f / fConst60;
		fConst79 = (fConst62 - fConst78) / fConst58 + 1.0f;
		fConst80 = (fConst62 + fConst78) / fConst58 + 1.0f;
		fConst81 = 1.2f / fConst64;
		fConst82 = 5.9749064f / fConst53;
		fConst83 = (fConst2 - fConst82) / fConst1 + 1.0f;
		fConst84 = (fConst2 + fConst82) / fConst1 + 1.0f;
		fConst85 = 0.95f / fConst56;
		fConst86 = std::exp(-(1e+01f / fConst0));
		fConst87 = 8388607.0f * (1.0f - fConst51);
		fConst88 = 1.0f / (fConst47 + 1.0f);
		fConst89 = 0.765f / fConst44;
		fConst90 = 4.700563f / fConst34;
		fConst91 = (fConst36 - fConst90) / fConst32 + 1.0f;
		fConst92 = (fConst36 + fConst90) / fConst32 + 1.0f;
		fConst93 = std::tan(157.07964f / fConst0);
		fConst94 = 1.0f / (fConst93 * fConst30);
		fConst95 = 1.0f / fConst93;
		fConst96 = 1.0f - fConst95;
		fConst97 = 1.0f / (fConst95 + 1.0f);
		fConst98 = 3.469284f / fConst21;
		fConst99 = (fConst23 - fConst98) / fConst19 + 1.0f;
		fConst100 = (fConst23 + fConst98) / fConst19 + 1.0f;
		fConst101 = 1.0f / (fConst6 * fConst17);
		fConst102 = 1.0f - fConst9;
		fConst103 = 1.0f / (fConst9 + 1.0f);
		fConst104 = 0.7943282f / fConst7;
		fConst105 = std::exp(-(12.5f / fConst0));
		fConst106 = std::exp(-(1e+03f / fConst0));
		fConst107 = 8388607.0f * (1.0f - fConst5);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Volume", &fHslider3, FAUSTFLOAT(0.8f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec2[0] = -(fConst4 * (fConst3 * fRec2[1] - (fRec0[1] + fRec0[2])));
			float fTemp0 = fConst20 * fRec9[1];
			float fTemp1 = fConst33 * fRec12[1];
			fRec13[0] = fSlow1 + 0.999f * fRec13[1];
			float fTemp2 = std::tan(fConst39 * std::max<float>(2e+03f, fRec13[0]));
			float fTemp3 = 1.0f / fTemp2;
			float fTemp4 = (fTemp3 + 1.4142135f) / fTemp2 + 1.0f;
			fRec15[0] = fSlow2 + 0.999f * fRec15[1];
			float fTemp5 = std::max<float>(-3.0f, -0.06f * fRec15[0]);
			int iTemp6 = fTemp5 > 0.0f;
			float fTemp7 = fConst40 * std::pow(1e+01f, 0.05f * std::fabs(fTemp5));
			float fTemp8 = ((iTemp6) ? fConst40 : fTemp7);
			float fTemp9 = fConst42 * (fConst42 + fTemp8) + 1.0f;
			float fTemp10 = ((iTemp6) ? fTemp7 : fConst40);
			float fTemp11 = fConst43 * fRec16[1];
			float fTemp12 = std::pow(0.02f * fRec15[0], 0.6f);
			float fTemp13 = 2.5f * fTemp12 + 1.0f;
			float fTemp14 = fConst52 * fRec21[1];
			float fTemp15 = fConst59 * fRec22[1];
			float fTemp16 = static_cast<float>(input0[i0]);
			fRec27[0] = fConst68 * std::fabs(fTemp16) + fConst67 * fRec27[1];
			float fTemp17 = fTemp16 * ((fRec27[0] > 0.006f) ? 1.0f : ((fRec27[0] > 0.0018f) ? 238.09525f * (fRec27[0] + -0.0018f) : 0.0f));
			fVec0[0] = fTemp17;
			fRec26[0] = -(fConst71 * (fConst70 * fRec26[1] - fConst69 * (fTemp17 - fVec0[1])));
			float fTemp18 = std::fabs(fRec26[0]);
			float fTemp19 = ((fTemp18 > fRec25[1]) ? fConst73 : fConst72);
			fRec25[0] = fTemp18 * (1.0f - fTemp19) + fRec25[1] * fTemp19;
			fRec24[0] = fConst74 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec25[0])) + -3.0f, 0.0f) + fConst66 * fRec24[1];
			float fTemp20 = fRec26[0] * std::pow(1e+01f, 0.05f * fRec24[0]);
			fVec1[0] = fTemp20;
			fRec23[0] = -(fConst77 * (fConst76 * fRec23[1] - fConst75 * (fTemp20 - fVec1[1])));
			fRec22[0] = fRec23[0] - fConst65 * (fConst63 * fRec22[2] + fTemp15);
			fRec21[0] = fConst81 * (fTemp15 + fConst80 * fRec22[0] + fConst79 * fRec22[2]) - fConst57 * (fConst55 * fRec21[2] + fTemp14);
			float fTemp21 = (fTemp14 + fConst84 * fRec21[0] + fConst83 * fRec21[2]) * (4.0f * fTemp12 + 0.5f);
			float fTemp22 = std::pow(std::fabs(fConst57 * fTemp21), 1.5f) + 1.0f;
			float fTemp23 = fTemp21 * (5.0f * fTemp12 + 0.5f);
			float fTemp24 = fConst85 * (fTemp23 / fTemp22);
			float fTemp25 = std::fabs(fTemp24);
			float fTemp26 = tanhf(2.772f * ((fTemp24 > 0.0f) ? fConst85 * (fTemp23 / (fTemp22 * (std::pow(fTemp25, 2.1f) + 1.0f))) : fConst85 * (fTemp23 / (fTemp22 * (std::pow(fTemp25, 2.8f) + 1.0f)))) * (2.0f * fTemp12 + 0.8f));
			float fTemp27 = std::fabs(0.765f * (fTemp26 / fTemp13));
			float fTemp28 = ((fTemp27 > fRec20[1]) ? fConst67 : fConst86);
			fRec20[0] = fTemp27 * (1.0f - fTemp28) + fRec20[1] * fTemp28;
			fRec19[0] = fConst87 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec20[0])) + -2.0f, 0.0f) + fConst51 * fRec19[1];
			float fTemp29 = fTemp26 * std::pow(1e+01f, 0.05f * fRec19[0]) / fTemp13;
			fVec2[0] = fTemp29;
			fRec18[0] = fConst88 * (0.765f * (fTemp29 + fVec2[1]) - fConst50 * fRec18[1]);
			fRec17[0] = fRec18[0] - fConst49 * (fConst48 * fRec17[2] + fConst46 * fRec17[1]);
			fRec29[0] = fConst88 * (fConst89 * (fTemp29 - fVec2[1]) - fConst50 * fRec29[1]);
			fRec28[0] = fRec29[0] - fConst49 * (fConst48 * fRec28[2] + fConst46 * fRec28[1]);
			fRec16[0] = fConst49 * (fConst45 * (fRec28[2] + (fRec28[0] - 2.0f * fRec28[1])) + 1.4125376f * (fRec17[2] + fRec17[0] + 2.0f * fRec17[1])) - (fRec16[2] * (fConst42 * (fConst42 - fTemp8) + 1.0f) + fTemp11) / fTemp9;
			fRec14[0] = (fTemp11 + fRec16[0] * (fConst42 * (fConst42 + fTemp10) + 1.0f) + fRec16[2] * (fConst42 * (fConst42 - fTemp10) + 1.0f)) / fTemp9 - (fRec14[2] * ((fTemp3 + -1.4142135f) / fTemp2 + 1.0f) + 2.0f * fRec14[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp2))) / fTemp4;
			fRec12[0] = (fRec14[2] + fRec14[0] + 2.0f * fRec14[1]) * (7.5e-05f * (8e+03f - fRec13[0]) + 1.0f) / fTemp4 - fConst38 * (fConst37 * fRec12[2] + fTemp1);
			fRec11[0] = fConst38 * (fTemp1 + fConst92 * fRec12[0] + fConst91 * fRec12[2]) - fConst31 * (fConst29 * fRec11[2] + fConst27 * fRec11[1]);
			float fTemp30 = fRec11[2] + fRec11[0] + 2.0f * fRec11[1];
			fVec3[0] = fTemp30;
			fRec10[0] = -(fConst97 * (fConst96 * fRec10[1] - fConst94 * (fTemp30 - fVec3[1])));
			fRec9[0] = fRec10[0] - fConst25 * (fConst24 * fRec9[2] + fTemp0);
			fRec8[0] = fConst25 * (fTemp0 + fConst100 * fRec9[0] + fConst99 * fRec9[2]) - fConst18 * (fConst16 * fRec8[2] + fConst14 * fRec8[1]);
			float fTemp31 = fRec8[2] + fRec8[0] + 2.0f * fRec8[1];
			fVec4[0] = fTemp31;
			fRec7[0] = -(fConst103 * (fConst102 * fRec7[1] - fConst101 * (fTemp31 - fVec4[1])));
			fRec6[0] = fRec7[0] - fConst11 * (fConst10 * fRec6[2] + fConst8 * fRec6[1]);
			fRec31[0] = -(fConst103 * (fConst102 * fRec31[1] - fConst18 * (fTemp31 + fVec4[1])));
			fRec30[0] = fRec31[0] - fConst11 * (fConst10 * fRec30[2] + fConst8 * fRec30[1]);
			float fTemp32 = fRec30[2] + fRec30[0] + 2.0f * fRec30[1] + fConst104 * (fRec6[2] + (fRec6[0] - 2.0f * fRec6[1]));
			float fTemp33 = std::fabs(fConst11 * fTemp32);
			float fTemp34 = ((fTemp33 > fRec5[1]) ? fConst106 : fConst105);
			fRec5[0] = fTemp33 * (1.0f - fTemp34) + fRec5[1] * fTemp34;
			fRec4[0] = fConst107 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec5[0])) + -8.0f, 0.0f) + fConst5 * fRec4[1];
			fRec32[0] = fSlow3 + 0.999f * fRec32[1];
			float fTemp35 = fRec32[0] * fTemp32 * std::pow(1e+01f, 0.05f * fRec4[0]);
			fVec5[0] = fTemp35;
			fRec3[0] = 0.995f * fRec3[1] + fConst11 * (fTemp35 - fVec5[1]);
			float fTemp36 = fRec3[0] + fRec2[0] * fRec1[0];
			fVec6[IOTA0 & 65535] = fTemp36;
			fRec33[0] = fSlow4 + 0.9999f * fRec33[1];
			float fTemp37 = fConst0 * fRec33[0];
			int iTemp38 = static_cast<int>(fTemp37);
			float fTemp39 = std::floor(fTemp37);
			fRec0[0] = fVec6[(IOTA0 - std::min<int>(44101, std::max<int>(0, iTemp38))) & 65535] * (fTemp39 + (1.0f - fTemp37)) + (fTemp37 - fTemp39) * fVec6[(IOTA0 - std::min<int>(44101, std::max<int>(0, iTemp38 + 1))) & 65535];
			float fTemp40 = 2.0f * fRec32[0] * tanhf(0.5f * (fRec3[0] + 0.7f * fRec0[0]));
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp40);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp40);
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec13[1] = fRec13[0];
			fRec15[1] = fRec15[0];
	...
	FAUST_ADDHORIZONTALSLIDER("Volume", fHslider3, 0.8f, 0.0f, 1.0f, 0.01f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(HORIZONTALSLIDER, Volume, "Volume", fHslider3, 0.8f, 0.0f, 1.0f, 0.01f) \
